...
import { Camera, CanvasMode, CanvasState,Color,LayerTypes,Point, Side, XYWH } from "@/types/canvas";
import { LiveObject } from "@liveblocks/client";
import { Info } from "./info";
import { Participants } from "./participants";
import { Toolbar } from "./toolbar";
import { CursorsPresence } from "./cursors-presence";
import { pointerEventtoCanvasPoint,connectionIdToColor, resizeBounds, findIntersectingLayerWithRectangle,penPointsToPathLayer, colorToCss } from "@/lib/utils";
...
export const Canvas = ({
    ...
    const insertLayer = useMutation((
        ...
        layerType: LayerTypes.Ellipse | LayerTypes.Rectangle | LayerTypes.Note | LayerTypes.Text,
        position: Point,
    )=>{
    ...
    const startMultiSelection = useCallback((
        ...
        if(Math.abs(current.x - origin.x) + Math.abs(current.y - origin.y) > 5){
            // console.log("Attempting to SelectionNet");
            setCanvasState({
                mode: CanvasMode.SelectionNet,
                origin,
                current,
    ...
    },[camera,canvasState, resizeSelectedLayer,traslateSelectedlayers,continueDrawing,startMultiSelection,updateSelectionNet]);
